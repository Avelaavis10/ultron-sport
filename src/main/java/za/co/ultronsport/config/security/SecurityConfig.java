...
@Configuration
@EnableWebSecurity
@EnableConfigurationProperties({JwtProperties.class, UltronCorsProperties.class})
public class SecurityConfig {

    private final JwtAuthenticationFilter jwtAuthenticationFilter;
    private final UltronUserDetailsService userDetailsService;
    private final SecurityErrorResponseWriter securityErrorResponseWriter;
    private final UltronCorsProperties corsProperties;

    public SecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter,
                          UltronUserDetailsService userDetailsService,
                          SecurityErrorResponseWriter securityErrorResponseWriter,
                          UltronCorsProperties corsProperties) {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/organisations/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/organisations", "/api/organisations/*").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/coach-profiles").hasRole("COACH")
                        .requestMatchers(HttpMethod.GET, "/api/coach-profiles/me").hasRole("COACH")
                        .requestMatchers(HttpMethod.PATCH, "/api/coach-profiles/me").hasRole("COACH")
                        .requestMatchers(HttpMethod.GET, "/api/coach-profiles/*").hasAnyRole("COACH", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/athlete-profiles").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.GET, "/api/athlete-profiles/me").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.PATCH, "/api/athlete-profiles/me").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.PATCH, "/api/athlete-profiles/me/organisation")
                        .hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.GET, "/api/athlete-profiles/*/achievements")
                        .hasAnyRole("ATHLETE", "COACH", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/athlete-profiles/*")
                        .hasAnyRole("ATHLETE", "COACH", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/athlete-profiles").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/achievements").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.GET, "/api/achievements/my").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.PATCH, "/api/achievements/*").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.GET, "/api/achievements").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/evidence/*/media/*").hasRole("ATHLETE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/evidence/*/verification-context")
                        .hasAnyRole("COACH", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/athlete-profiles/me").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/athlete-profiles/me").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/athlete-profiles/me/organisation")
                        .hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.GET, "/api/v1/athlete-profiles/*/achievements")
                        .hasAnyRole("ATHLETE", "COACH", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/achievements/my").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/achievements/*").hasRole("ATHLETE")
                        .requestMatchers(HttpMethod.GET, "/api/v1/achievements/athlete/*")
                        .hasAnyRole("ATHLETE", "COACH", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/achievements").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/coach-profiles").hasRole("COACH")
                        .requestMatchers(HttpMethod.GET, "/api/v1/coach-profiles/me").hasRole("COACH")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/coach-profiles/me").hasRole("COACH")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/organisations/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/organisations", "/api/v1/organisations/*")
                        .authenticated()
